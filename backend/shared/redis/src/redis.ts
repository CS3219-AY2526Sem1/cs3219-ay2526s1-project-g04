...
export class Redis {
    ...
    public async setStringValueByKey(key: string, value: string | number): Promise<void> {
        await this.client.set(key, value)
    }

    public async setDictValueByKey(key: string, value: Record<string, any>): Promise<void> {

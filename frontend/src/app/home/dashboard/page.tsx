        ...
        >
          ...
          <Box sx={{ width: { xs: '100%', lg: '66.66%' } }}>
            <Stack spacing={4}>
              ...
              >
                ...
                <Paper sx={{ p: 3, borderRadius: 3, boxShadow: '0px 4px 12px rgba(0,0,0,0.05)' }}>
                    <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 2, pb:0 }}>
            ...
            <Box sx={{ width: { xs: '100%', lg: '33.33%' } }}>
                <Stack spacing={4}>
                    <Box>
                        <Typography variant="h4" sx={{ fontWeight: 700, fontFamily: openSans.style.fontFamily, color: '#374151', mb: 2 , opacity: 0.6}}>
                            Summary
                        </Typography>
                        <Stack spacing={2}>
                          <Paper sx={{ p: 3, borderRadius: 3, boxShadow: '0px 4px 12px rgba(0,0,0,0.05)' }}>
                          <Typography variant="h6" sx={{ fontWeight: 700, color: '#374151', mb: 1, opacity: 0.8 }}>
                              Total solved
                          </Typography>
                            <Typography variant="h3" sx={{ fontWeight: 700, color: '#4F46E5', mt: -1, py: 2 }}>
                                {stats.totalSolved} Problems
                            </Typography>
                            <Stack direction="row" spacing={1}>
                                <Chip label={`Easy ${stats.easy}`} variant="outlined" sx={{ fontWeight: 600, color: DIFFICULTY_LEVELS[0].color_hex, borderColor: DIFFICULTY_LEVELS[0].color_hex }} />
                                <Chip label={`Med ${stats.medium}`} variant="outlined" sx={{ fontWeight: 600, color: DIFFICULTY_LEVELS[1].color_hex, borderColor: DIFFICULTY_LEVELS[1].color_hex }} />
                                <Chip label={`Hard ${stats.hard}`} variant="outlined" sx={{ fontWeight: 600, color: DIFFICULTY_LEVELS[2].color_hex, borderColor: DIFFICULTY_LEVELS[2].color_hex }} />
                            </Stack>
                          </Paper>
                        </Stack>
                    </Box>
